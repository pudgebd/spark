...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#myCreateTableStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMyCreateTableStmt(SqlBaseParser.MyCreateTableStmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code setPartitionLocation}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSetPartitionLocation(SqlBaseParser.SetPartitionLocationContext ctx);
	/**
