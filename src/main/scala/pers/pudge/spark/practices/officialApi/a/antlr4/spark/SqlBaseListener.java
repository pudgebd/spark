...
public interface SqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#myCreateTableStmt}.
	 * @param ctx the parse tree
	 */
	void enterMyCreateTableStmt(SqlBaseParser.MyCreateTableStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#myCreateTableStmt}.
	 * @param ctx the parse tree
	 */
	void exitMyCreateTableStmt(SqlBaseParser.MyCreateTableStmtContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code setPartitionLocation}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterSetPartitionLocation(SqlBaseParser.SetPartitionLocationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code setPartitionLocation}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitSetPartitionLocation(SqlBaseParser.SetPartitionLocationContext ctx);
	/**
